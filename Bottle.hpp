...
class Bottle {//
    ...
    double a, b;
    //методы класса
    friend Bottle operator+(const Bottle& lhv,const Bottle& rhv); //friend для обращения к privat членам класса
    friend Bottle operator-(const Bottle& lhv,const Bottle& rhv);
